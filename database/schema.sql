-- ============================================================
--  THE SPICY VENUE v4 - Database Schema
--  Run: mysql -u root -p22kb1a0573 < database/schema.sql
-- ============================================================

CREATE DATABASE IF NOT EXISTS spicy_venue CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE spicy_venue;
...
(1,1,'Idli Sambar','Soft steamed idlis with spicy sambar',60,1,'https://static.toiimg.com/thumb/115501753/115501753.jpg?height=746&width=420&resizemode=76&imgsize=94996'),
...
(16,3,'Buttermilk','Salted spiced buttermilk',20,1,'https://www.trulydesi.in/cdn/shop/articles/3_8a1a3548-3fa6-4fe2-9209-8a0e0ca96032.jpg?v=1758521132');
